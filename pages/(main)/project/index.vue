...
const addProject = async () => {
  try {
    ...
    if (data) {
      await refreshNuxtData(FetchKeys.PROJECTS_IN_PROGRESS);
    }
  } catch {}
};

const projectId = ref("VvX0Cxz");
const workName = ref("");
...
const {
  ...
  execute,
  refresh,
} = await useLazyFetch(`/api/project/${projectId.value}/works`, {
...
<template>
  <div class="py-40 space-y-20 container mx-auto">
    ...
    <!-- <CreateWorkCard/> -->
    <div
      class="flex items-center p-4 border space-x-20 max-w-[800px] mx-auto rounded dark:bg-background"
    >
      ...
      <div class="max-w-80 w-1/3 flex items-center space-x-4">
        ...
        <Select>
          ...
          <SelectContent position="popper">
            <SelectItem value="nuxt"> Project 1 </SelectItem>
