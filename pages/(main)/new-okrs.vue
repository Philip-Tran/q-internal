...
const steps = [
  {
    step: 1,
    title: "Decide objective",
    description: "What I am trying to achieve",
  },
  {
    step: 2,
    title: "Key results",
    description: "What are the key results to achieve the objective",
  },
  {
    step: 3,
    title: "Option",
    description: "Monthly objective or quarter objective",
  },
];
                  ...
                  <div class="flex flex-col gap-4 mt-4 min-h-[250px]">
                    ...
                    <template v-if="stepIndex === 2" v-auto-animate>
                      ...
                      >
                        ...
                        >
                          <FormItem class="w-3/4">
                            <FormControl>
                              <Input
                                type="text"
                                v-model="keyResults[index].keyResultName"
                                v-bind="componentField"
                              />
                            </FormControl>
                            <FormMessage />
                        ...
                        <FormField
                          v-slot="{ componentField }"
                          :name="`keyResults[${index}].keyResultNumber`"
                        >
                          <FormItem class="w-1/4">
                            <FormControl>
                              <Input
                                type="number"
                                v-model="keyResults[index].keyResultNumber"
                                v-bind="componentField"
                              />
                            </FormControl>
                            <FormMessage />
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          @click.prevent="removeKeyResult(index)"
